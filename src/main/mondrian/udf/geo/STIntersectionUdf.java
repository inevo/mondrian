...
/**
 * Implementation of the ST_Intersection spatial analysis function
 *
 ...
 *
 */
public class STIntersectionUdf implements UserDefinedFunction {
    ...
    public Object execute(Evaluator evaluator, Argument[] arguments) {
        ...
        if (arg1 instanceof Geometry && arg2 instanceof Geometry) {
            return ((Geometry) arg1).intersection((Geometry) arg2);
        }
    ...
    public String getDescription() {
        return "Returns a geometry that is the common part of two geometries";
    }
