...
/**
 * Implementation of the ST_Envelope spatial analysis function
 *
 ...
 *
 */
public class STEnvelopeUdf implements UserDefinedFunction {

    public Object execute(Evaluator evaluator, Argument[] arguments) {
        Object arg1 = arguments[0].evaluateScalar(evaluator);
        if (arg1 instanceof Geometry) {
            return ((Geometry) arg1).getEnvelope();
        }
    ...
    public String getDescription() {
        return "Returns the envelope (bounding box) of a geometry";
    }
