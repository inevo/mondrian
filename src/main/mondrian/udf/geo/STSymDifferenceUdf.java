...
/**
 * Implementation of the ST_SymDifference spatial analysis function
 *
 ...
 *
 */
public class STSymDifferenceUdf implements UserDefinedFunction {
    ...
    public Object execute(Evaluator evaluator, Argument[] arguments) {
        ...
        if (arg1 instanceof Geometry && arg2 instanceof Geometry) {
            return ((Geometry) arg1).symDifference((Geometry) arg2);
        }
    ...
    public String getDescription() {
        return "Returns a geometry that is the symmetric difference of two" +
        		" geometries (i.e. the parts that don't intersect)";
    }
